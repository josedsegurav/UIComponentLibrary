...
>`
  ...
  font-size: ${({ $size }) => {
    switch ($size) {
      ...
      case 'large': return 'clamp(1rem, 3vw, 1.125rem)';    // 16px - 18px
  ...
  padding: ${({ $size }) => {
    switch ($size) {
      case 'small': return 'clamp(0.5rem, 2vw, 0.625rem) clamp(0.75rem, 3vw, 1rem)';     // 8px-10px vertical, 12px-16px horizontal
      case 'large': return 'clamp(0.75rem, 3vw, 1rem) clamp(1.25rem, 4vw, 1.75rem)';     // 12px-16px vertical, 20px-28px horizontal
      default: return 'clamp(0.625rem, 2.5vw, 0.75rem) clamp(1rem, 3.5vw, 1.5rem)';      // 10px-12px vertical, 16px-24px horizontal
    }
  }};
  ...
  @media (min-width: 1024px) {
    ...
    padding: ${({ $size }) => {
      switch ($size) {
        ...
        case 'large': return '0.875rem 1.75rem';
        default: return '0.6875rem 1.25rem';
      }
    }};
  }
